...
function App() {
  ...
  const fetchPosts = async () => {
    try {
      const response = await axios.get('https://blogapp-complete-be-sanjay.onrender.com/api/posts');
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      const response = await axios.post('https://blogapp-complete-be-sanjay.onrender.com/api/posts', {
        postName,
        description
      });
  ...
  const handleUpdate = async () => {
    try {
      await axios.put(`https://blogapp-complete-be-sanjay.onrender.com/api/posts/${editIndex}`, {
  ...
  const handleDelete = async (postId) => {
    try {
      await axios.delete(`https://blogapp-complete-be-sanjay.onrender.com/api/posts/${postId}`);
